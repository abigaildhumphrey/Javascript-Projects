...
function placeXOro(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            ...
            //If activePlayer is squal to 'O', the o.png is placed in HTML
...
function arrayIncludes(squareA, squareB, squareC) {
    ...
    //returned and our else if conditions executes the drawWinLine.
...
//This function takes a string parameter of the path you set easlier for
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    //This line gives us access to methods and props to use on canvas 
    ...
    let x1 = coordX1,
        ...
        x = x1,
        //This variable stores temporary y axis we update in our animation loop
        y = y1;
       
    //This function interacts with the canvas 
    function animateLineDrawing() {
        const animationLoop = requestAnimationFrame(animateLineDrawing);
        //This method clears content from last loop interaction
        ...
        //This method draws everything above 
        c.stroke();
        //This condition checks if we've reached th endpoint
        if (x1 <= x2 && y1 <= y2) {
            //This condiiton adds 10 to previous end x point
            if (x < x2) { x += 10; }
...
function resetGame() {
    //This is for loop iterates through each HTML square element
    for (let i = 0; i < 9; i++) {
